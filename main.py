...
def main():
    ...
    if "messages" not in st.session_state:
        st.session_state.messages = [
            ...
            AIMessage(content="Hello! I'm here to assist you in crafting a STEAL paragraph for your essay. I'm here to guide you, not to write for you./n To begin, please share your essay question./n Let's work together to make your writing shine!")
        ]
